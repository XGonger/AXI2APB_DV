...
# DVE full session
# Saved on Sun Mar 30 23:33:07 2025
# Designs open: 1
...
gui_set_pref_value -key app_default_font -value {Courier 10 Pitch,14,-1,5,75,0,0,0,0,0}
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{5 65} {2562 1161}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 216} {height 816} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2557} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed=1 +UVM_TESTNAME=gon_axi2apb_smoke_test +UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name gon_axi2apb_smoke_test_1 -do gon_axi2apb_sim_run.do}}
...
gui_sim_run Ucli -exe gon_axi2apb_tb.simv -args { -a run.log +ntb_random_seed=1 +UVM_TESTNAME=gon_axi2apb_smoke_test +UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name gon_axi2apb_smoke_test_1 -do gon_axi2apb_sim_run.do -ucligui} -dir /home/ICer/ic_prjs/AXI2APB/sim/out/obj -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active uvm_custom_install_recording /home/synopsys/vcs-mx/O-2018.09-1/etc/uvm-1.2/vcs/uvm_vcs_record_interface.sv
