...
gui_create_state_key -category Widget_History -key TopLevel.1|qt_left_dock|DockWnd3|HSPane.1|pages|Class.1|hbox|textfilter -value_type string -value {*axi_master_driver* *axi_transfer* *apb_slave_dr* *smoke_virt*}
