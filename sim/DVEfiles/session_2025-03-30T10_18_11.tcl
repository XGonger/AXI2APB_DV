...
# DVE full session
# Saved on Sun Mar 30 10:18:11 2025
# Designs open: 1
#   Sim: /home/icstudy/Desktop/axi2apb_03_12/sim/out/obj/gon_axi2apb_tb.simv
...
#<Session mode="Full" path="/home/icstudy/Desktop/axi2apb_03_12/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 65} {2317 1176}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 434} {height 494} {dock_state left} {dock_on_new_line true} {child_hier_colhier 332} {child_hier_coltype 94} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 653]
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 653
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 757
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 652} {height 494} {dock_state left} {dock_on_new_line true} {child_data_colvariable 317} {child_data_colvalue 157} {child_data_coltype 154} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 484]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 2258
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 484
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2317} {height 483} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMEXE {/home/icstudy/Desktop/axi2apb_03_12/sim/out/obj/gon_axi2apb_tb.simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/icstudy/Desktop/axi2apb_03_12/sim/out/obj/gon_axi2apb_tb.simv}] } {
gui_sim_run Ucli -exe gon_axi2apb_tb.simv -args {-ucligui -l run.log +ntb_random_seed=1 +UVM_TESTNAME=gon_axi2apb_smoke_test +UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name gon_axi2apb_smoke_test_1} -dir /home/icstudy/Desktop/axi2apb_03_12/sim/out/obj -nosource
}
}
...
gui_view_scroll -id ${Source.1} -vertical -set 5346
