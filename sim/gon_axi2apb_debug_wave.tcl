...
# DVE full session
# Saved on Tue Mar 11 22:14:59 2025
# Designs open: 1
#   Sim: out/obj/gon_axi2apb_tb.simv
...
#<Session mode="Full" path="/home/icstudy/Desktop/axi2apb_03_11/sim/gon_axi2apb_debug_wave.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 65} {2557 1161}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 435} {height 508} {dock_state left} {dock_on_new_line true} {child_hier_colhier 332} {child_hier_coltype 94} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 653} {height 508} {dock_state left} {dock_on_new_line true} {child_data_colvariable 317} {child_data_colvalue 157} {child_data_coltype 154} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 485]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 485
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2557} {height 484} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 139} {2557 1235}}
...
gui_set_env SIMSETUP::SIMEXE {out/obj/gon_axi2apb_tb.simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {out/obj/gon_axi2apb_tb.simv}] } {
gui_sim_run Ucli -exe gon_axi2apb_tb.simv -args {-ucligui -l run.log +ntb_random_seed=1 +UVM_TESTNAME=gon_axi2apb_smoke_test +UVM_VERBOSITY=UVM_HIGH -cm_dir out/cov.vdb -cm_name gon_axi2apb_smoke_test_1} -dir out/obj -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_29" { gon_axi2apb_tb.dut.rid gon_axi2apb_tb.dut.rdata gon_axi2apb_tb.dut.rresp {gon_axi2apb_tb.axi_if[0].debug_rd_resp} gon_axi2apb_tb.dut.rlast gon_axi2apb_tb.dut.rvalid gon_axi2apb_tb.dut.rready }

set _session_group_30 Group6
gui_sg_create "$_session_group_30"
set Group6 "$_session_group_30"

gui_sg_addsignal -group "$_session_group_30" { gon_axi2apb_tb.dut.pclk gon_axi2apb_tb.dut.presetn gon_axi2apb_tb.dut.paddr gon_axi2apb_tb.dut.pwdata gon_axi2apb_tb.dut.pwrite gon_axi2apb_tb.dut.penable gon_axi2apb_tb.dut.psel_s0 gon_axi2apb_tb.dut.psel_s1 gon_axi2apb_tb.dut.psel_s2 gon_axi2apb_tb.dut.prdata_s0 gon_axi2apb_tb.dut.prdata_s1 gon_axi2apb_tb.dut.prdata_s2 }

set _session_group_31 Group7
gui_sg_create "$_session_group_31"
set Group7 "$_session_group_31"

gui_sg_addsignal -group "$_session_group_31" { gon_axi2apb_tb.apb_if.pclk gon_axi2apb_tb.apb_if.presetn }

set _session_group_32 Group8
gui_sg_create "$_session_group_32"
set Group8 "$_session_group_32"

gui_sg_addsignal -group "$_session_group_32" { {gon_axi2apb_tb.axi_if[0].AXI_ACLK} {gon_axi2apb_tb.axi_if[0].AXI_ARESET_N} }
...
gui_list_set_filter -id ${Class.1} -text {*smoke_virt*}
...
gui_list_show_data -id ${Data.1} {gon_axi2apb_tb.axi_if[0]}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {{gon_axi2apb_tb.axi_if[0].debug_rd_length} }}
gui_view_scroll -id ${Data.1} -vertical -set 1328
...
gui_view_scroll -id ${Source.1} -vertical -set 5350
...
gui_marker_move -id ${Wave.1} {C1} 100500
